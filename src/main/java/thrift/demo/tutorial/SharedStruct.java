...
public class SharedStruct implements org.apache.thrift.TBase<SharedStruct, SharedStruct._Fields>, java.io.Serializable, Cloneable, Comparable<SharedStruct> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new SharedStructStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new SharedStructTupleSchemeFactory();
