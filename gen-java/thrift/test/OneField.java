...
public class OneField implements org.apache.thrift.TBase<OneField, OneField._Fields>, java.io.Serializable, Cloneable, Comparable<OneField> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new OneFieldStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new OneFieldTupleSchemeFactory();
