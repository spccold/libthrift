...
public class VersioningTestV1 implements org.apache.thrift.TBase<VersioningTestV1, VersioningTestV1._Fields>, java.io.Serializable, Cloneable, Comparable<VersioningTestV1> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new VersioningTestV1StandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new VersioningTestV1TupleSchemeFactory();
