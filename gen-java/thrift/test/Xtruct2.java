...
public class Xtruct2 implements org.apache.thrift.TBase<Xtruct2, Xtruct2._Fields>, java.io.Serializable, Cloneable, Comparable<Xtruct2> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new Xtruct2StandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new Xtruct2TupleSchemeFactory();
