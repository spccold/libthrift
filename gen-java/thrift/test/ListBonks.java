...
public class ListBonks implements org.apache.thrift.TBase<ListBonks, ListBonks._Fields>, java.io.Serializable, Cloneable, Comparable<ListBonks> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new ListBonksStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new ListBonksTupleSchemeFactory();
