...
public class GuessProtocolStruct implements org.apache.thrift.TBase<GuessProtocolStruct, GuessProtocolStruct._Fields>, java.io.Serializable, Cloneable, Comparable<GuessProtocolStruct> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new GuessProtocolStructStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new GuessProtocolStructTupleSchemeFactory();
