...
public class EmptyStruct implements org.apache.thrift.TBase<EmptyStruct, EmptyStruct._Fields>, java.io.Serializable, Cloneable, Comparable<EmptyStruct> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new EmptyStructStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new EmptyStructTupleSchemeFactory();
...
;
  ...
  private static class EmptyStructTupleSchemeFactory implements SchemeFactory {
    public EmptyStructTupleScheme getScheme() {
      return new EmptyStructTupleScheme();
    }
  }

  private static class EmptyStructTupleScheme extends TupleScheme<EmptyStruct> {
