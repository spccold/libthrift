...
public class Xtruct implements org.apache.thrift.TBase<Xtruct, Xtruct._Fields>, java.io.Serializable, Cloneable, Comparable<Xtruct> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new XtructStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new XtructTupleSchemeFactory();
