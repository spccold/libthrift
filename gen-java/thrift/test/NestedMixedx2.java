...
public class NestedMixedx2 implements org.apache.thrift.TBase<NestedMixedx2, NestedMixedx2._Fields>, java.io.Serializable, Cloneable, Comparable<NestedMixedx2> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new NestedMixedx2StandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new NestedMixedx2TupleSchemeFactory();
