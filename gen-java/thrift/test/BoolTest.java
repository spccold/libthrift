...
public class BoolTest implements org.apache.thrift.TBase<BoolTest, BoolTest._Fields>, java.io.Serializable, Cloneable, Comparable<BoolTest> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new BoolTestStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new BoolTestTupleSchemeFactory();
