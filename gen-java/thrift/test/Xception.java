...
public class Xception extends org.apache.thrift.TException implements org.apache.thrift.TBase<Xception, Xception._Fields>, java.io.Serializable, Cloneable, Comparable<Xception> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new XceptionStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new XceptionTupleSchemeFactory();
