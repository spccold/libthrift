...
public class Bools implements org.apache.thrift.TBase<Bools, Bools._Fields>, java.io.Serializable, Cloneable, Comparable<Bools> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new BoolsStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new BoolsTupleSchemeFactory();
