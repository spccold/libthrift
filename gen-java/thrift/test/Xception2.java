...
public class Xception2 extends org.apache.thrift.TException implements org.apache.thrift.TBase<Xception2, Xception2._Fields>, java.io.Serializable, Cloneable, Comparable<Xception2> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new Xception2StandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new Xception2TupleSchemeFactory();
